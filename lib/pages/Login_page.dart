...
import '../widget/CustomIcons.dart';
...
class _LoginPageState extends State<LoginPage> {
 ...
 Widget radioButton(bool _isSelected) =>Container(
   ...
   decoration: BoxDecoration(
     shape: BoxShape.circle,border: Border.all(width: 2.0, color: Colors.white)),
            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  Row(
                    children: <Widget>[
                     // Image.asset("assets/images/icon-710x599-android.png",
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          Text("Remember me",
                              style: TextStyle(
                                  fontSize: 12, fontFamily: "BethEllen"))
                        ],
                      ),
                      InkWell(
                        child: Container(
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Text("Social Login",
                          style: TextStyle(
                              fontSize: 16.0, fontFamily: "BethEllen")),
                      horizontalLine()
                    ],
                  ),
                  SizedBox(
